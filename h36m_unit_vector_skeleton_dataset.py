                    ...
                    for frame in tensor:
                        ...
                        for joint in joints:
                            ...
                            if parent is None:
                                ...
                                norm_coordinates.append(
                                    norm_coordinates[parent * tensor.shape[2] + 0] + norm_delta_x / 2)
                                norm_coordinates.append(
                                    norm_coordinates[parent * tensor.shape[2] + 1] + norm_delta_y / 2)
                                norm_coordinates.append(
                                    norm_coordinates[parent * tensor.shape[2] + 2] + norm_delta_z / 2)
